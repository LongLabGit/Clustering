...
cd ../../
ops.root='S:/Vigi/Datasets/SiliconProbe/Kristina/';
...
ops.chanMap =  'Extra/ChanMaps/tetrode.mat';
...
ops.fslow              = 20000;   % frequency for low pass filtering
...
ops.nNeigh      = 4; % number of neighboring templates to retain projections of (16)
