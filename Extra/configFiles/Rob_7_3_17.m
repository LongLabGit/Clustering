...
cd ../../
ops.root='Z:/Robert/INT_connectivity/SiProbe/PracticeBird_070317/SiProbe/Continuous_400_cut/';
ops.fbinary=[ops.root,'amplifier_cut.dat'];
ops.fproc=[ops.root,'temp_wh.dat'];
ops.datatype            = 'dat';  % binary ('dat', 'bin') or 'openEphys'
ops.NchanTOT            = 64;    % total number of channels
ops.fs                  = 20000; % sampling rate
ops.chanMap =  'Extra/chanMaps/ChanMapBird_12broken.mat';
