...
cd ../../
ops.root='S:/Vigi/CorticalSpikes/Data/387/rec_2/';
ops.fbinary=[ops.root,'amplifier_64.fil'];
ops.fproc=[ops.root,'temp_wh.dat'];
ops.datatype            = 'dat';  % binary ('dat', 'bin') or 'openEphys'
ops.NchanTOT            = 64; % total number of channels
ops.fs                  = 20000; % sampling rate
ops.chanMap =  'Extra/ChanMaps/387_2.mat';
...
ops.Th               = [3 5 5];    % threshold for detecting spikes on template-filtered data ([6 12 12]) 
...
ops.fslow              = 2500;   % frequency for low pass filtering
