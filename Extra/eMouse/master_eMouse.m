...
fpath    = '..\..\Extra\eMouse\eMouseData\'; % where on disk do you want the simulation? ideally and SSD...
% if ~exist(fpath, 'dir'); mkdir(fpath); end

% This part adds paths
addpath(genpath('S:\Vigi\Matlab\NeuroGrid\Clustering\KiloSort\')) % path to kilosort folder
addpath(genpath('S:\Vigi\Matlab\NeuroGrid\Clustering\Extra\npy-matlab')) % path to npy-matlab scripts
pathToYourConfigFile = '..\..\Extra\eMouse\'; % for this example it's ok to leave this path inside the repo, but for your own config file you *must* put it somewhere else!  
