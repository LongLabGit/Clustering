function [SamplingInterval, nChannels, AnalogVoltage] = loadAnalogSignalIntan(SiProbePath, analogFilename)

frequency_parameters = read_Intan_RHD2000_frequency_parameters([SiProbePath,'info.rhd']);%This will just spit out details
[~, ~, ~, nChannels, ~, ~] = read_Intan_RHD2000_channel_numbers([SiProbePath,'info.rhd']);
...
num_channels = nChannels; % ADC input info from header file
