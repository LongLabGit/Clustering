function [SamplingInterval, AnalogVoltage] = loadAnalogSignalIntan(SiProbePath)
...
fileinfo = dir([SiProbePath,'analogin_cut.dat']);
num_samples = fileinfo.bytes/(num_channels * 2); % uint16 = 2 bytes
fid = fopen([SiProbePath,'analogin_cut.dat'], 'r');
